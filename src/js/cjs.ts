...
Carson Gross's idea. I am strongly in favour of this, define behavior that is pertinent to the module or part that uses it and not define it elsewhere unless
it is a universal construct.
...
H, S, A, C - shorthand gestures to clean up the visual mess induced by javascript into markup.

Ticker - What syncs everything together
...
const otherStyle: Partial<CSSStyleDeclaration> = {
  pointerEvents: "none"
}
const otherStyle2: Partial<CSSStyleDeclaration> = {
  userSelect: "none",
  accentColor: "red"
}
NCSS(["section-hero"], {
